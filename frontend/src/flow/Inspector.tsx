    ...
    <div className="p-4 space-y-3 font-mono text-[11px]">
      ...
      <div className="pt-4 space-y-2">
        <button
          ...
          className="w-full font-mono text-[10px] uppercase tracking-wider py-2 border border-dashed border-[hsl(var(--ink))] hover:bg-[hsl(var(--ink))] hover:text-[hsl(var(--paper))] transition-colors"
        >
          duplicate node (⌘D)
        </button>
        {!confirming ? (
